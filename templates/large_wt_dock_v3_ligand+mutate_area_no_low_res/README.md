...
Add:
- change cycles in high res docker to 600 from 100, this is because current runs need 3 variants per run.
This will switch that to 1 variant per job submission. 
- change nstructs too 100, submit 5000 runs of 100 nstructs , for a total of, 500,000 nstructs 
