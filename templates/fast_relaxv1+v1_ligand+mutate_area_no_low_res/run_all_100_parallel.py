...
def process_mutation_group(args):
    ...
    for pos, aa in mutations:
        ...
        try:
            ...
            # Create a temporary options file for docking that points to the correct PDB and the new dock XML
            ...
            # MODIFIED: Target 'dock.xml' as specified in your options file
...
def main():
    ...
    num_cores = 30 # Adjust based on your machine
